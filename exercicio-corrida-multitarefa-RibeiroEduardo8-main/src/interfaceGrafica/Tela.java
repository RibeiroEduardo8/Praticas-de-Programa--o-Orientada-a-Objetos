...
public class Tela {
    ...
    private void criarCompetidores() {
        ...
        Corredor corredor2= new Corredor("Jocicleiton", 10);
        Corredor corredor3= new Corredor("Joseilton", 30);
        competidores.add(corredor);
        competidores.add(corredor2);
        competidores.add(corredor3);
    ...
    private boolean estaCorrendo(){
        ...
        System.out.println(estaCorrendo);
            return estaCorrendo;
    }
