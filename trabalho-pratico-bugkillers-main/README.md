...
# Banco de dados - Instrução # 

O Banco de Dados vem cadastrado com 3 tipos de Usuário:

Administrador -> nome: admin / senha: admin
Moderador -> nome: mod / senha: mod
Usuário Comum -> nome: comum / senha: comum

Somente Administradores podem excluir Celebridades e excluir Usuários.
Moderadores tem acesso as outras funções com exceção das listadas acima.
Usuários Comuns não tem acesso a essa parte.

## Definição do Grupo

**Nome do grupo**: .. Bug Killers ..

**Tema escolhido**: .. Celebridades ..

**Integrantes** (preencha abaixo):

- Saimon Gabriel de Andrade
- Eduardo Augusto Ribeiro
- Luis Fernando Rodrigues Monteiro
- 
...
| 3.1.9 | Foi adicionada alguma biblioteca (arquivo `.jar`)?                 | (sim (qual? sqlite-jdbc-3.40.0.0.jar)|
